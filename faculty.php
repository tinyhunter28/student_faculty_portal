		...
		<h2>FACULTY PORTAL</h2>
				...
				<center>
					<div class="row uniform">
						...
						<div class="6u 12u$(xsmall)">
							<button class="button fit" onclick="document.getElementById('id02').style.display='block'" style="width:auto" style="width:auto">REGISTER</button>
						</div>
                    </div>
...
<form class="modal-content animate" action="Login/FacultyLogin.php" method='POST'>
...
<form class="modal-content animate" action="Login/FacultySignUp.php" method='POST'>
    <div class="imgcontainer">
